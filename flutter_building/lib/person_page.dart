...
class PersonPage extends StatefulWidget {
  ...
  PersonPage(this.name,this.text,this.publish,this.favorite,this.star,this.core);
        ...
        child: Stack(
          children: <Widget>[
            Positioned(
              ...
              top: left * 0.2,
              bottom: left * 0.2 / 2,
              child: FrontWidget(open,widget.name,widget.text,widget.publish,widget.favorite,widget.star,widget.core),
            ),
          ],
        ),
      ),
