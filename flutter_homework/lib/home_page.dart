...
import 'package:flutter_homework/publish_page.dart';
                ...
                Column(
                    children: <Widget>[
                      Container(
                        ...
                        height: 560,
                        child: PageViewWidget(widget.name),
                      ),
                    ]
                ),
                Padding(
                        ...
                        child:  RaisedButton(
                          ...
                          onPressed: () async {
                            if (widget.name == "") {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => PublishPage(widget.name,"发布作品",VacationBean("","",""))),
                              );
                            }
                          },
                          child: Text(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          ...
          Navigator.of(context).push(MaterialPageRoute(builder: (context) {
            return ImgPage(bean,widget.name,false,false,false,false);
          }));
        },
          child: Container(
          padding: EdgeInsets.only(
