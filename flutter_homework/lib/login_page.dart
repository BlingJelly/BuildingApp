          ...
          if (_formKey.currentState!.validate()) {
            ...
            collection.where({
              ...
              if(total == 0){
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => IndexPage(_username)),
                );
              }
              print("登录成功");
            }).catchError((e) {
        ...
        children: [
          FlatButton(
            ...
            onPressed: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ForgetPage("获得新密码")),
              );
            },
          ),
          FlatButton(
            ...
            onPressed: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => RegistPage("快速注册")),
              );
            },
          )
        ],
